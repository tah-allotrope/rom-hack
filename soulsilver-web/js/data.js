...
// F flowers, H house wall, R roof, D door(mat, warp), C counter, L table,
...
export const MAPS = {
  newbark: {
    ...
    warps: { "9,12": "lab,4,6", "10,12": "lab,4,6", "5,5": "house,3,5", "22,10": "route29,1,5" },
  },
  house: {
    w: 8, h: 7,
    rows: T([
    ...
    warps: { "3,5": "newbark,5,6", "4,5": "newbark,5,6" },
  },
  lab: {
    w: 10, h: 9,
    rows: T([
    ...
    warps: { "4,7": "newbark,9,13", "5,7": "newbark,9,13" },
  },
  route29: {
    w: 40, h: 13,
    rows: T([
  ...
  violetgate: {
    ...
    warps: { "0,3": "route29,38,7", "7,3": "violet,0,8" },
  },
  violet: {
    w: 24, h: 17,
    rows: T([
    ...
    // center door (6,5), east house door (16,5), gym door (12,13)
    warps: { "6,5": "center,3,5", "16,5": "violethouse,3,5", "12,13": "gym,4,8", "0,8": "violetgate,6,3" },
  ...
  center: {
    ...
    warps: { "4,5": "violet,6,6", "5,5": "violet,6,6" },
  },
  violethouse: {
    w: 8, h: 7,
    rows: T([
    ...
    warps: { "3,5": "violet,17,6", "4,5": "violet,17,6" },
  },
  gym: {
    w: 10, h: 11,
    rows: T([
    ...
    warps: { "4,9": "violet,12,14", "5,9": "violet,12,14" },
  },
};
